import { Transaction } from '../../../src.ts';
import type { ResourceEntry } from '../../../src/browser/metrics.ts';
import { _addMeasureSpans, _addResourceSpans } from '../../../src/browser/metrics.ts';
